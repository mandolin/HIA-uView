...
This workspace contains the initial private HIA-uView UniApp UI implementation: `UButton`, its constrained loading-message resolver, HIA theme tokens, a component manifest, and a compile-only `mp-weixin` fixture. It is not published and has no versioned external package API yet.
...
The pre-release [UButton](../docs/button.md), [UStack](../docs/stack.md), [UNavBar](../docs/nav-bar.md), and [UCell](../docs/cell.md) contracts define implementation boundaries. Component contracts, accessibility expectations, styling tokens, and upstream-reference boundaries are published before component implementation begins. See the [design-system contract](../docs/design-system.md). This package must not own application data, business flows, backend integration, or industry fields.
