...
The [local catalog composition example](../docs/local-composition.md) combines the current components with application-owned anonymous mock data and local state. It is compiler/runtime evidence only, not a HIA-uView-Biz module, industry starter, backend contract, router, or device-support claim.
