...
The pre-release [UButton](../docs/button.md), [UStack](../docs/stack.md), [UNavBar](../docs/nav-bar.md), [UCell](../docs/cell.md), [UInput](../docs/input.md), [UField](../docs/field.md), and [UValidationMessage](../docs/validation-message.md) contracts define the implemented boundaries. The private pre-implementation [UModal](../docs/modal.md), [UNotice](../docs/notice.md), and [UEmpty](../docs/empty.md) contracts define controlled feedback and empty-data boundaries before those components become runtime exports. Component contracts, accessibility expectations, styling tokens, and upstream-reference boundaries are published before implementation changes. See the [design-system contract](../docs/design-system.md). This package must not own application data, business flows, backend integration, or industry fields.
