...
The pre-release [UButton](../docs/button.md), [UStack](../docs/stack.md), [UNavBar](../docs/nav-bar.md), [UCell](../docs/cell.md), [UInput](../docs/input.md), [UField](../docs/field.md), and [UValidationMessage](../docs/validation-message.md) contracts define the implemented boundaries. Component contracts, accessibility expectations, styling tokens, and upstream-reference boundaries are published before implementation changes. See the [design-system contract](../docs/design-system.md). This package must not own application data, business flows, backend integration, or industry fields.
