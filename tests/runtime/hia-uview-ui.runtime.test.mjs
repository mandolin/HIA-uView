...
import UView, { UButton, UVIEW_COMPONENTS } from '../../HIA-uView-UI/src/index.mjs';

/**
 * @module hia-uview-ui.runtime.test
 * @lang zh-CN 使用真实 Vue runtime 验证 UButton 的首轮交互与显式 plugin 边界；测试不启动 Vitest UI/API、Vite dev server 或任何网络服务。
 * @lang en Uses a real Vue runtime to verify first-slice UButton interaction and explicit-plugin boundaries; tests start no Vitest UI/API, Vite dev server, or network service.
 */
...
it('keeps registration and style consumption explicit', async () => {
  ...
  expect(UVIEW_COMPONENTS).toHaveLength(1);
