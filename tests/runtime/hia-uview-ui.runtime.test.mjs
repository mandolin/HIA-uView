...
import UView, { UButton, UCell, UCheckbox, UCheckboxGroup, UEmpty, UField, UInput, UModal, UNavBar, UNotice, URadio, URadioGroup, UStack, UValidationMessage, UVIEW_COMPONENTS } from '../../HIA-uView-UI/src/index.mjs';
...
it('keeps registration and style consumption explicit', async () => {
  ...
  expect(UVIEW_COMPONENTS).toHaveLength(14);
