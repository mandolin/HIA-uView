...
it('keeps registration and style consumption explicit', async () => {
  ...
  // <lang><zh-CN>显式安装是唯一注册入口；集合长度与当前二十一项私有组件声明一致。</zh-CN><en>Explicit installation is the only registration entry; collection length matches the current twenty-one private component declarations.</en></lang>
