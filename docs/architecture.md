...
Themes, styles, accessibility, and localization use a separate [design-system contract](design-system.md). It defines semantic boundaries and verification requirements without publishing a versioned external runtime API or brand assets. [HiaButton](button.md) is the first private implementation and retains its explicit pre-release contract.
